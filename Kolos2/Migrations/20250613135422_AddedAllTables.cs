    ...
    public partial class AddedAllTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Trees", x => x.SpeciesId);
                });

            migrationBuilder.CreateTable(
                name: "SeedllingBatches",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SeedllingBatches", x => x.BatchId);
                    table.ForeignKey(
                        name: "FK_SeedllingBatches_Nurseries_NurseryId",
                        column: x => x.NurseryId,
                        principalTable: "Nurseries",
                        principalColumn: "NurseryID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SeedllingBatches_Trees_SpeciesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Responsibles_SeedllingBatches_BatchId",
                        column: x => x.BatchId,
                        principalTable: "SeedllingBatches",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SeedllingBatches_NurseryId",
                table: "SeedllingBatches",
                column: "NurseryId");

            migrationBuilder.CreateIndex(
                name: "IX_SeedllingBatches_SpeciesId",
                table: "SeedllingBatches",
                column: "SpeciesId");
        }
